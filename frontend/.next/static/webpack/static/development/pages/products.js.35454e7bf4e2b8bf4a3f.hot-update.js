...
})(["border-bottom:1px solid #cccccc;background-color:", ";padding:0rem;transition:all 0.2s;display:grid;grid-template-columns:50px 1fr;align-items:center;img{margin-right:10px;}"], function (props) {
...
})(["position:relative;input{width:100%;padding:10px;border:2px solid black;font-size:2rem;margin-bottom:0px;&.loading{animation:", " 0.5s ease-in-out infinite alternate;border-radius:25px 25px 0px 0px !important;}&:focus{border:2px solid #765ee9;border-radius:4px 4px 0px 0px;}}"], glow);


/***/ })

})
//# sourceMappingURL=products.js.35454e7bf4e2b8bf4a3f.hot-update.js.map