...
})(["position:absolute;display:grid;grid-template-columns:50px 1fr;align-items:center;width:100%;z-index:2;border:1px solid #cccccc;"]);
var DropDownItem = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].div.withConfig({
  displayName: "DropDown__DropDownItem",
  componentId: "p88a4e-1"
})(["border-bottom:1px solid #cccccc;background:", ";padding:1rem;transition:all 0.2s;", ";display:flex;align-items:center;border-left:10px solid ", ";img{margin-right:10px;}"], function (props) {
  return 'purple' ? '#f7f7f7' : undefined;
}, function (props) {
  return 'purple' ? 'padding-left: 2rem;' : undefined;
}, function (props) {
  return 'purple' ? '#cccccc' : undefined;
});
...
})(["position:relative;input{width:100%;padding:10px;border:2px solid black;font-size:2rem;&.loading{animation:", " 0.5s ease-in-out infinite alternate;}&:focus{border:2px solid #765ee9;}}"], glow);


/***/ })

})
//# sourceMappingURL=products.js.98cb4ad504fede1c264f.hot-update.js.map