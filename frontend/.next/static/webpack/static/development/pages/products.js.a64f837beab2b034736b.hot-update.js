...
})(["background-color:", ";padding:1.25rem 0rem;transition:all 0.2s;", ";display:grid;grid-template-columns:50px 1fr;align-items:center;padding-left:2rem;cursor:pointer;transform:scale(1.05);border:2px solid;border-image:linear-gradient( to top right,#704ce5 0%,#4c66e6 50%,#4cb3e6 100% );border-image-slice:1;}*/ p{margin-left:10px;margin-bottom:0px;}"], function (props) {
...
//# sourceMappingURL=products.js.a64f837beab2b034736b.hot-update.js.map