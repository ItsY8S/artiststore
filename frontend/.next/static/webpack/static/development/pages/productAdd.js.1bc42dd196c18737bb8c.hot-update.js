  ...
  function ProductAdd() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSwapInput", function (e) {
      ...
      if (itExists == null) {
        ...
        productImageInput.setAttribute('class', 'live-input exists product-hero');
        productImageInput.setAttribute('type', 'file');
        productImageInput.setAttribute('accept', 'image/png, image/jpeg');
        productImageInput.setAttribute('name', 'image');
        productImageInput.setAttribute('style', 'display: none');
        productImageInput.setAttribute('onchange', "document.getElementById('hero').src = window.URL.createObjectURL(this.files[0])");
...
//# sourceMappingURL=productAdd.js.1bc42dd196c18737bb8c.hot-update.js.map