...
})(["border-bottom:1px solid #cccccc;background-color:", ";padding:1.25rem 0rem;transition:all 0.2s;display:grid;grid-template-columns:50px 1fr;align-items:center;&:hover{background-color:#eee;transform:scale(1,1.1);}p{margin-left:10px;margin-bottom:0px;}"], function (props) {
...
//# sourceMappingURL=products.js.787cfb75a67e52653cce.hot-update.js.map