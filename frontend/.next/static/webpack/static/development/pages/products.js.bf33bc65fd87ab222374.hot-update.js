...
})(["position:absolute;width:100%;z-index:2;border-left:2px solid #888888;border-right:2px solid #888888;border-bottom:2px solid #888888;border-radius:0 0 25px 15px;"]);
var DropDownItem = styled_components__WEBPACK_IMPORTED_MODULE_0__["default"].div.withConfig({
  displayName: "DropDown__DropDownItem",
  componentId: "p88a4e-1"
})(["background-color:", ";padding:1.25rem 0rem;transition:all 0.2s;display:grid;grid-template-columns:50px 1fr;align-items:center;&:hover{cursor:pointer;transform:scale(1.05);border:2px solid;border-image:linear-gradient( to top right,#704ce5 0%,#4c66e6 50%,#4cb3e6 100% );border-image-slice:1;}p{margin-left:10px;margin-bottom:0px;}"], function (props) {
...
//# sourceMappingURL=products.js.bf33bc65fd87ab222374.hot-update.js.map