...
function (_React$Component) {
  ...
  function ProductAdd() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleImageChange", function (e) {
      console.log(e.src || e); // document.getElementById('hero').src = window.URL.createObjectURL(this.files[0])

      var _e$target2 = e.target,
          name = _e$target2.name,
          type = _e$target2.type,
          value = _e$target2.value; // console.log(e)
...
//# sourceMappingURL=productAdd.js.8119e6ca50f072fcb665.hot-update.js.map