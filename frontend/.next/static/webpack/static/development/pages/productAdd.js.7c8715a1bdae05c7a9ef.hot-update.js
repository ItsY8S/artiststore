...
function (_React$Component) {
  ...
  function ProductAdd() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleImageChange", function (e) {
      console.log(e.src); // document.getElementById('hero').src = window.URL.createObjectURL(this.files[0])
...
//# sourceMappingURL=productAdd.js.7c8715a1bdae05c7a9ef.hot-update.js.map