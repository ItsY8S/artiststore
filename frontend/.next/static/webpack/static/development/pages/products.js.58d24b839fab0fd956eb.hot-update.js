...
})(["border-bottom:1px solid #cccccc;background-color:", ";padding:1.25rem 0rem;transition:all 0.2s;display:grid;grid-template-columns:50px 1fr;align-items:center;&:hover{cursor:pointer;transform:scale(1.05);border:2px solid;border-image:linear-gradient( to top right,#704ce5 0%,#4c66e6 50%,#4cb3e6 100% );border-image-slice:1;border-image-outset:0px;}p{margin-left:10px;margin-bottom:0px;}"], function (props) {
...
//# sourceMappingURL=products.js.58d24b839fab0fd956eb.hot-update.js.map