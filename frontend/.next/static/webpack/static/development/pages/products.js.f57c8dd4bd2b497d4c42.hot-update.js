...
})(["position:relative;input{width:100%;padding:10px;border:2px solid black;font-size:2rem;margin-bottom:0px;&.loading{animation:", " 0.5s ease-in-out infinite alternate;border-radius:25px 25px 0px 0px;}&:focus{border:2px solid #765ee9;border-radius:4px 4px 0px 0px;}}"], glow);


/***/ })

})
//# sourceMappingURL=products.js.f57c8dd4bd2b497d4c42.hot-update.js.map